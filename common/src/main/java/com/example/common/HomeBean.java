...
public class HomeBean implements Parcelable {
    ...
    public static class ResultBean implements Parcelable {
        ...
        private List<SeckillInfoBean.ListBean> hot_info;
        private List<SeckillInfoBean.ListBean> recommend_info;
        ...
        public List<SeckillInfoBean.ListBean> getHot_info() {
            return hot_info;
        }

        public void setHot_info(List<SeckillInfoBean.ListBean> hot_info) {
            this.hot_info = hot_info;
        }

        public List<SeckillInfoBean.ListBean> getRecommend_info() {
            return recommend_info;
        }

        public void setRecommend_info(List<SeckillInfoBean.ListBean> recommend_info) {
            this.recommend_info = recommend_info;
        }

        public static class SeckillInfoBean implements Parcelable {
            ...
            public static class ListBean implements Parcelable {
                ...
                public void writeToParcel(Parcel dest, int flags) {
                    ...
                    dest.writeString(this.origin_price);
                ...
                protected ListBean(Parcel in) {
                    ...
                    this.origin_price = in.readString();
            ...
            protected SeckillInfoBean(Parcel in) {
                this.end_time = in.readString();
                this.start_time = in.readString();
                this.list = in.createTypedArrayList(ListBean.CREATOR);
            }

            public static final Creator<SeckillInfoBean> CREATOR = new Creator<SeckillInfoBean>() {
                @Override
                public SeckillInfoBean createFromParcel(Parcel source) {
                    return new SeckillInfoBean(source);
                }

                @Override
                public SeckillInfoBean[] newArray(int size) {
                    return new SeckillInfoBean[size];
                }
            };
        }
        ...
        public static class ActInfoBean implements Parcelable {
            ...
            protected ActInfoBean(Parcel in) {
                this.icon_url = in.readString();
                this.name = in.readString();
                this.url = in.readString();
            }

            public static final Creator<ActInfoBean> CREATOR = new Creator<ActInfoBean>() {
                @Override
                public ActInfoBean createFromParcel(Parcel source) {
                    return new ActInfoBean(source);
                }

                @Override
                public ActInfoBean[] newArray(int size) {
                    return new ActInfoBean[size];
                }
            };
        }
        ...
        public static class BannerInfoBean implements Parcelable {
            ...
            public ActInfoBean getValue() {
                return value;
            }

            public void setValue(ActInfoBean value) {
                this.value = value;
            }
            ...
            protected BannerInfoBean(Parcel in) {
                ...
                this.value = in.readParcelable(ActInfoBean.class.getClassLoader());
            }
        ...
        @Override
        public void writeToParcel(Parcel dest, int flags) {
            dest.writeParcelable(this.seckill_info, flags);
            dest.writeList(this.act_info);
            dest.writeList(this.banner_info);
            dest.writeList(this.channel_info);
            dest.writeTypedList(this.hot_info);
            dest.writeTypedList(this.recommend_info);
        }
        ...
        protected ResultBean(Parcel in) {
            this.seckill_info = in.readParcelable(SeckillInfoBean.class.getClassLoader());
            this.act_info = new ArrayList<ActInfoBean>();
            in.readList(this.act_info, ActInfoBean.class.getClassLoader());
            this.banner_info = new ArrayList<BannerInfoBean>();
            in.readList(this.banner_info, BannerInfoBean.class.getClassLoader());
            this.channel_info = new ArrayList<ChannelInfoBean>();
            in.readList(this.channel_info, ChannelInfoBean.class.getClassLoader());
            this.hot_info = in.createTypedArrayList(SeckillInfoBean.ListBean.CREATOR);
            this.recommend_info = in.createTypedArrayList(SeckillInfoBean.ListBean.CREATOR);
        }
