...
import com.example.dimensionleague.databinding.FindSendRvBinding;
...
public class FindSendFragment extends BaseBindFragment<FindSendRvBinding> {
    ...
    @Override
    protected void initView(FindSendRvBinding bindView) {
        recommendAdapter = new MineRecommendAdapter(R.layout.item_mine_rv_recommend, list);
        bindView.findRv.setLayoutManager(new GridLayoutManager(getContext(), 2));
        bindView.findRv.setAdapter(recommendAdapter);
