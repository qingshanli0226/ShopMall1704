...
public class KeyWordFramLayout extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public KeyWordFramLayout(@NonNull Context context) {
        super(context);
        init();
    }

    public KeyWordFramLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public KeyWordFramLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
