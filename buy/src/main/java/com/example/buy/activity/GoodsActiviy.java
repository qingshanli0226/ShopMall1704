...
//        获取到用户点击的商品     发起请求,获取商品数据
        ...
        showGoodsBean = new Gson().fromJson(str, ShowGoodsBean.class);
...
//        verifyNumber();
    ...
    private void setAnimator() {
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                car.addListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        super.onAnimationEnd(animation);
    ...
    private void setPopuWindow() {
        ...
        Button popuAddCart = view.findViewById(R.id.popuAddCart);
        popuNum.setText(1+"");
        ...
        popuAddCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                popupWindow.dismiss();
                setAnimator();
    ...
    protected void onDestroy() {
        super.onDestroy();
        disPreseter(addCartPresenter,verifyOnePresenter);
    }
